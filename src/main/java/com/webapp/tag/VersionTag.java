...
//        VersionService versionService =  SpringApplicationContext.getBean(VersionService.class);
//        List<Version> versionList = versionService.findVersions(verIds);
//        this.model.put("versions",versionList);
        try {
            Configuration configuration = new Configuration();
            configuration.setClassForTemplateLoading(com.webapp.tag.VersionTag.class, "template");
